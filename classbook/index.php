    ...
    <body>
        <div class="container">
            <div class="codrops-top">
                <a href="http://cnvnt.ro/">
                    <strong>Colegiul National Vocational "Nicolae Titulescu"</strong>
                </a>
                <span class="right">
		...
		{	$nume=$_POST['nume'];
			...
			{	if(!mysql_select_db("site"))
					{	$rez = mysql_query("create database site;");
						...
						$tabel = mysql_query("CREATE TABLE utilizatori (id int primary key auto_increment, nume char(30) unique key, prenume char(30), parola char(30), email char(30) unique key, varsta int, clasa char(10), rol char(3));");
						...
						$tabel3= mysql_query("CREATE TABLE profesori (id int primary key auto_increment, nume char(30) unique key, dirigentie char(9) unique key);");
					}
				else
					$baza=mysql_select_db("site");
					$intr=mysql_query("INSERT INTO utilizatori (nume,prenume,parola,email,rol) VALUES('$nume','$prenume','$parola','$email','elv');");
					if($intr)
						{
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form autocomplete="on" method="post"> 
                                <h1>Autentificare</h1> 
                                <p> 
                                    <label for="username" class="mail" data-icon="u" > Email </label>
	...
	<!-- INREGISTRARE -->
                        <div id="register" class="animate form">
                            <form  autocomplete="on" method="post"> 
                                ...
                                <p> 
                                    <label for="passwordsignup_confirm" class="youpasswd" data-icon="p">Confirmă Parola </label>
                                ...
                                <p class="change_link">  
									Ai deja cont?
									<a href="#autentificare" class="to_register"> Autentifică-te </a>
								</p>
                            </form>
                        </div>
	<!-- //INREGISTRARE -->
